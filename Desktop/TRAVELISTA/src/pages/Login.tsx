...
import { Check, X, LogIn, Loader2, Mail, Lock, Globe, RefreshCw, Plane, MapPin, Compass, Eye, EyeOff } from 'lucide-react';
...
const Login = () => {
  ...
  const { login, signupWithGoogle, sendVerificationEmail } = useAuth();
        ...
        <div className="w-full max-w-md animate-fade-in">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 md:p-10 border border-gray-200">
            <div className="mb-8 text-center">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Welcome back, Explorer!</h1>
              ...
              <div className="form-input-wrapper">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="••••••••"
                    className="form-input pl-10 pr-10 bg-white border-gray-200 text-gray-900 placeholder-gray-500 focus:border-gray-900 focus:ring-gray-900"
                    required
                  />
                  <button
                    type="button"
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link to="/signup" className="text-gray-900 font-medium hover:text-gray-700 hover:underline">
                  Sign up now
                </Link>
              </p>
            </div>
